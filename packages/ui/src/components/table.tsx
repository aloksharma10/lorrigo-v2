...
function Table({ className, ...props }: React.ComponentProps<'table'>) {
  return (
    <div data-slot="table-container" className="relative w-full overflow-x-auto lg:w-auto lg:overflow-x-visible">
...
function TableHeader({ className, ...props }: React.ComponentProps<'thead'>) {
  return (
    <thead
      ...
      className={cn('sticky top-0 z-10 border-b border-gray-200 dark:border-gray-700 dark:bg-transparent dark:shadow-none [&_tr]:border-b', className)}
      {...props}
    />
  );
}
