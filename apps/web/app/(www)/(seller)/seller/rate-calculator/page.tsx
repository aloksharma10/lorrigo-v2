...
export default function RateCalculator() {
  ...
  const [sortBy, setSortBy] = useState<'price' | 'name' | 'pickup'>('price');
  ...
  const handleCalculate = async () => {
    ...
    try {
      ...
      const params: RateCalculationParams = {
        ...
        sizeUnit: 'cm', // or allow user to select
                ...
                <CardContent className="p-4">
                  <div className="flex flex-wrap items-center justify-between gap-4">
                    <div className="flex items-center gap-4">
                      ...
                      <Select value={sortBy} onValueChange={(value: 'price' | 'name' | 'pickup') => setSortBy(value)}>
                        <SelectTrigger className="w-40">
                      ...
                      <div className="mb-4 flex items-start justify-between">
                        <div className="flex-1">
                          <div className="mb-2 flex items-center gap-2">
                            ...
                            {index === 0 && <Badge className="bg-green-100 text-xs text-green-800">Best Value</Badge>}
                          </div>
