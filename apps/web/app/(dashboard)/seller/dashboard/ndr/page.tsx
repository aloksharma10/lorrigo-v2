      ...
      <div className="mx-auto p-4 space-y-6">
         ...
         <div className="flex flex-col">
            ...
            <div className="text-sm text-muted-foreground mb-6">
               The NDR dashboard is showing you the realtime data of last 30 days till today based on shipment assigned
               date.
            </div>
            ...
            <div className="mb-6">
               <ChartCard title="NDR Summary">
                  <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
                     <MetricCard title="NDR Raised" value={ndrMetricsData.raised} className="bg-gray-50 dark:bg-neutral-900" />
                     <MetricCard title="NDR Raised Percentage" value={ndrMetricsData.percentage} className="bg-gray-50 dark:bg-neutral-900" />
                     <MetricCard title="Action Required" value={ndrMetricsData.actionRequired} className="bg-gray-50 dark:bg-neutral-900" />
                     <MetricCard title="Delivered" value={ndrMetricsData.delivered} className="bg-gray-50 dark:bg-neutral-900" />
                     <MetricCard title="Your RTO" value={ndrMetricsData.rto} className="bg-gray-50 dark:bg-neutral-900" />
                  </div>
               </ChartCard>
            </div>
               ...
               <ChartCard title="NDR Response Summary">
                  <div className="grid grid-cols-2 gap-4">
                     <div className="flex flex-col items-center justify-center p-4 border rounded-md">
                        ...
                        <div className="text-sm text-muted-foreground">Seller Response</div>
                     </div>
                     <div className="flex flex-col items-center justify-center p-4 border rounded-md">
                        <div className="text-2xl font-bold">{ndrResponseSummaryData.buyerResponse}</div>
                        <div className="text-sm text-muted-foreground">Buyer Response</div>
                     </div>
                     <div className="flex flex-col items-center justify-center p-4 border rounded-md">
                        <div className="text-2xl font-bold">{ndrResponseSummaryData.sellerPositiveResponse}</div>
                        <div className="text-sm text-muted-foreground">Seller Positive Response</div>
                     </div>
                     <div className="flex flex-col items-center justify-center p-4 border rounded-md">
                        <div className="text-2xl font-bold">{ndrResponseSummaryData.buyerPositiveResponse}</div>
                        <div className="text-sm text-muted-foreground">Buyer Positive Response</div>
                     </div>
                     <div className="flex flex-col items-center justify-center p-4 border rounded-md">
                        <div className="text-2xl font-bold">{ndrResponseSummaryData.sellerPositiveResponseDelivered}</div>
                        <div className="text-sm text-muted-foreground">Seller Positive Response Delivered</div>
                     </div>
                     <div className="flex flex-col items-center justify-center p-4 border rounded-md">
                        <div className="text-2xl font-bold">{ndrResponseSummaryData.buyerPositiveResponseDelivered}</div>
                        <div className="text-sm text-muted-foreground">Buyer Positive Response Delivered</div>
                     </div>
                  </div>
               </ChartCard>
               ...
               <ChartCard title="NDR Funnel">
                  <div className="grid grid-cols-3 gap-4">
                     <div className="border rounded-md p-4">
                        <div className="text-center mb-2 font-medium">1st NDR</div>
                        <div className="flex flex-col gap-2">
                           <div className="flex flex-col items-center justify-center p-2 rounded-md">
                              <div className="text-sm font-medium">{ndrFunnelData.firstNDR.total}</div>
                              <div className="text-xs text-center text-muted-foreground">Total Shipments</div>
                           </div>
                           <div className="flex flex-col items-center justify-center p-2 rounded-md">
                              <div className="text-sm font-medium">{ndrFunnelData.firstNDR.pending}</div>
                              <div className="text-xs text-center text-muted-foreground">Pending Shipments</div>
                           </div>
                           <div className="flex flex-col items-center justify-center p-2 rounded-md">
                              <div className="text-sm font-medium">{ndrFunnelData.firstNDR.delivered}</div>
                              <div className="text-xs text-center text-muted-foreground">Delivered Shipments</div>
                           </div>
                        </div>
                     </div>
                     <div className="border rounded-md p-4">
                        <div className="text-center mb-2 font-medium">2nd NDR</div>
                        <div className="flex flex-col gap-2">
                           <div className="flex flex-col items-center justify-center p-2 dark:bg-neutral-900 rounded-md">
                     ...
                     <div className="border rounded-md p-4">
                        <div className="text-center mb-2 font-medium">3rd NDR</div>
                        <div className="flex flex-col gap-2">
                           <div className="flex flex-col items-center justify-center p-2 dark:bg-neutral-900 rounded-md">
