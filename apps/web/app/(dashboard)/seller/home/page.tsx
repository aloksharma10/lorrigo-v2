import { IconClockPause, IconDeviceIpadExclamation, IconTruck, IconTruckDelivery, IconTruckReturn } from "@tabler/icons-react";
...
export default function Home() {
   return (
      <div className="@container/main p-4 space-y-6 flex flex-1 flex-col gap-2 lg:gap-4">
         <div className="grid grid-cols-1 lg:grid-cols-3 lg:gap-4">
            <Card className="w-full">
               <CardHeader>
                  <CardTitle className="scroll-m-20 text-lg md:text-xl font-semibold tracking-tight">Getting Started</CardTitle>
               </CardHeader>
