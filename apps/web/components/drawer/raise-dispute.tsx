    ...
    <div className="flex h-full flex-col">
      ...
      <div className="flex-1 overflow-y-auto p-6">
        <div className="space-y-6">
          ...
          <div>
            <h3 className="text-base font-semibold mb-3">Weight Discrepancy Details Shared by Courier</h3>
            <Card>
          ...
          {/* Add Product Details */}
          <div>
            <h3 className="text-base font-semibold mb-3">Add Product Details</h3>
          ...
          <div>
            <h3 className="text-base font-semibold mb-3">Upload Sample Shipment Images</h3>
            <div className="grid grid-cols-5 gap-4">
              {[
                ...
                <div key={index} className="flex flex-col items-center">
                  ...
                  />
                  <div 
                    className={`w-full aspect-square border-2 border-dashed rounded-md flex flex-col items-center justify-center cursor-pointer hover:bg-gray-50 ${images[index] ? 'border-blue-500' : 'border-gray-300'}`}
            ...
            <div className="text-xs text-muted-foreground mt-2">* Images should be less than 5 MB</div>
          </div>
          ...
          {/* Guidelines */}
          <div>
            <h3 className="text-base font-semibold mb-3">Guidelines to Upload Sample Shipment Images</h3>
            <div className="grid grid-cols-3 gap-6">
              <div className="border rounded-md p-4">
                ...
                <p className="text-xs text-muted-foreground">
                  Make sure that the measuring device is placed alongside the dimension to be measured.
                </p>
              </div>
              <div className="border rounded-md p-4">
                ...
                <p className="text-xs text-muted-foreground">
                  Make sure the package weight is visible on the weighing scale before uploading the image.
                </p>
              </div>
              <div className="border rounded-md p-4">
                ...
                <p className="text-xs text-muted-foreground">
                  Make sure the shipping label is clearly visible before uploading the image.
                </p>
              </div>
            </div>
          </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <label htmlFor="comment" className="text-base font-semibold">Comment</label>
          ...
          <div>
            <Alert className="bg-yellow-50 border-yellow-200">
              ...
              <AlertDescription className="text-yellow-700">
                The charged weight is the higher of the actual weight and the volumetric weight. Volumetric weight is calculated as (Length × Width × Height) ÷ 5000.
              </AlertDescription>
            </Alert>
          </div>
        </div>
