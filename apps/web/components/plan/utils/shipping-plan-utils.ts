    ...
    return {
      ...
      zonePricing: {
        Z_A: {
          ...
          increment_price:
            Math.round(courier.zonePricing.Z_A.increment_price * adjustmentFactor * 100) / 100,
          rto_base_price:
            Math.round(courier.zonePricing.Z_A.rto_base_price * adjustmentFactor * 100) / 100,
          rto_increment_price:
            Math.round(courier.zonePricing.Z_A.rto_increment_price * adjustmentFactor * 100) / 100,
        },
        Z_B: {
          ...courier.zonePricing.Z_B,
          base_price: Math.round(courier.zonePricing.Z_B.base_price * adjustmentFactor * 100) / 100,
          increment_price:
            Math.round(courier.zonePricing.Z_B.increment_price * adjustmentFactor * 100) / 100,
          rto_base_price:
            Math.round(courier.zonePricing.Z_B.rto_base_price * adjustmentFactor * 100) / 100,
          rto_increment_price:
            Math.round(courier.zonePricing.Z_B.rto_increment_price * adjustmentFactor * 100) / 100,
        },
        Z_C: {
          ...courier.zonePricing.Z_C,
          base_price: Math.round(courier.zonePricing.Z_C.base_price * adjustmentFactor * 100) / 100,
          increment_price:
            Math.round(courier.zonePricing.Z_C.increment_price * adjustmentFactor * 100) / 100,
          rto_base_price:
            Math.round(courier.zonePricing.Z_C.rto_base_price * adjustmentFactor * 100) / 100,
          rto_increment_price:
            Math.round(courier.zonePricing.Z_C.rto_increment_price * adjustmentFactor * 100) / 100,
        },
        Z_D: {
          ...courier.zonePricing.Z_D,
          base_price: Math.round(courier.zonePricing.Z_D.base_price * adjustmentFactor * 100) / 100,
          increment_price:
            Math.round(courier.zonePricing.Z_D.increment_price * adjustmentFactor * 100) / 100,
          rto_base_price:
            Math.round(courier.zonePricing.Z_D.rto_base_price * adjustmentFactor * 100) / 100,
          rto_increment_price:
            Math.round(courier.zonePricing.Z_D.rto_increment_price * adjustmentFactor * 100) / 100,
        },
        Z_E: {
          ...courier.zonePricing.Z_E,
          base_price: Math.round(courier.zonePricing.Z_E.base_price * adjustmentFactor * 100) / 100,
          increment_price:
            Math.round(courier.zonePricing.Z_E.increment_price * adjustmentFactor * 100) / 100,
          rto_base_price:
            Math.round(courier.zonePricing.Z_E.rto_base_price * adjustmentFactor * 100) / 100,
          rto_increment_price:
            Math.round(courier.zonePricing.Z_E.rto_increment_price * adjustmentFactor * 100) / 100,
        },
      },
    };
  });
