...
export function CreatePlanForm() {
   ...
   return (
      <Card className="w-full mx-auto flex flex-col">
         {/* Fixed Header */}
         <CardHeader className="sticky flex justify-between items-center top-0 z-10 bg-background p-4 border-b gap-4">
            <div>
                           ...
                           render={({ field }) => (
                              <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3">
                                 <div className="space-y-0.5">
                                    ...
                                    <div className="text-sm text-muted-foreground">Set this as the default plan for new users</div>
                                 </div>
                                 <FormControl>
                                    <Switch checked={field.value} onCheckedChange={field.onChange} disabled={isCreating} />
                                 </FormControl>
                              </FormItem>
                           )}
                        />
                  ...
                  <div className="space-y-4">
                     ...
                     <Accordion type="multiple" className="space-y-4">
                        {courierFields.map((field, courierIndex) => {
                           ...
                           return (
                              <AccordionItem key={field.id} value={`courier-${courierIndex}`} className="border rounded-lg">
                                 <>
                                    <AccordionTrigger className="px-4 hover:no-underline">
                                       <div className="flex items-center justify-between w-full mr-4">
                                          ...
                                          <div
                                             ...
                                             className={`p-1 rounded hover:bg-destructive/10 text-destructive cursor-pointer ${courierFields.length === 1 || isCreating ? "opacity-50 cursor-not-allowed" : ""
                                                }`}
                                          >
                                             <Trash2 className="h-4 w-4" />
                                          </div>
                                                ...
                                                <FormItem>
                                                   ...
                                                   >
                                                      <FormControl>
                                                         <SelectTrigger>
                                                            <SelectValue
                                                               placeholder={isLoadingCouriers ? "Loading couriers..." : "Choose a courier"}
                                                            />
                                                         </SelectTrigger>
                                                      </FormControl>
                                                      <SelectContent>
                                                         {couriers.map((courier) => (
                                                            <SelectItem key={courier.id} value={courier.id}>
                                                               <div className="flex items-center gap-2">
                                                                  ...
                                                                  <span className="text-xs text-muted-foreground">({courier.code})</span>
                                                               </div>
                                                            </SelectItem>
                                                         ))}
                                                      </SelectContent>
                                             ...
                                             <FormField
                                                ...
                                                render={({ field }) => (
                                                   <FormItem>
                                                      ...
                                                      <FormControl>
                                                         <Input type="number" step="0.01" disabled={isCreating} {...field} />
                                                      </FormControl>
                                                      <FormMessage />
                                                   </FormItem>
                                                )}
                                             ...
                                             <FormField
                                                ...
                                                render={({ field }) => (
                                                   <FormItem>
                                                      ...
                                                      <FormControl>
                                                         <Input type="number" step="0.01" max="100" disabled={isCreating} {...field} />
                                                      </FormControl>
                                                      <FormMessage />
                                                   </FormItem>
                                                )}
                                             ...
                                             <FormField
                                                ...
                                                render={({ field }) => (
                                                   <FormItem>
                                                      ...
                                                      <FormControl>
                                                         <Input type="number" step="0.1" disabled={isCreating} {...field} />
                                                      </FormControl>
                                                      <FormMessage />
                                                   </FormItem>
                                                )}
                                          ...
                                          <div className="space-y-4">
                                             ...
                                             <div className="space-y-4 grid grid-cols-1 md:grid-cols-3 gap-4">
                                                {Object.entries(zoneLabels).map(([zoneKey, zoneLabel]) => (
                                                   <div key={zoneKey} className="border rounded-lg p-4 space-y-4">
                                                      <h5 className="font-medium text-sm">{zoneLabel}</h5>
                                                      <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                                                         <FormField
                                                            control={form.control}
                                                            name={`courierPricing.${courierIndex}.zonePricing.${zoneKey}.base_price` as any}
                                                            render={({ field }) => (
                                                               <FormItem>
                                                         ...
                                                         <FormField
                                                            ...
                                                            render={({ field }) => (
                                                               <FormItem>
                                                                  <FormLabel className="text-xs">Increment Price</FormLabel>
                                                                  <FormControl>
                                                                     <Input type="number" step="0.01" disabled={isCreating} {...field} />
                                                                  </FormControl>
                                                                  <FormMessage />
                                                         ...
                                                         <FormField
                                                            ...
                                                            render={({ field }) => (
                                                               <FormItem>
                                                                  <FormLabel className="text-xs">RTO Base Price</FormLabel>
                                                                  <FormControl>
                                                                     <Input type="number" step="0.01" disabled={isCreating} {...field} />
                                                                  </FormControl>
                                                                  <FormMessage />
                                                         ...
                                                         <FormField
                                                            ...
                                                            render={({ field }) => (
                                                               <FormItem>
                                                                  <FormLabel className="text-xs">Flat RTO Charge</FormLabel>
                                                                  <FormControl>
                                                                     <Input type="number" step="0.01" disabled={isCreating} {...field} />
                                                                  </FormControl>
                                                                  <FormMessage />
                                                         ...
                                                         <FormField
                                                            ...
                                                            render={({ field }) => (
                                                               <FormItem className="flex flex-row items-center justify-between rounded-lg border p-2">
                                                                  <div className="space-y-0.5">
                                                                     <FormLabel className="text-xs">RTO Same as FW</FormLabel>
                                                                  </div>
                                                                  <FormControl>
                                                                     <Switch
                                                                        checked={field.value}
         ...
         {/* Fixed Footer */}
         <CardFooter className="flex-shrink-0 border-t bg-muted/20 p-6">
            <PlanSubmitBtn />
         </CardFooter>
      </Card>
   )
