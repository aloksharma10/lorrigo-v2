export default function RefundPolicy() {
  return (
    <div className="mx-auto p-6">
      ...
      <div className="mb-8">
        <h3 className="mb-2 text-lg font-semibold">Refund Eligibility</h3>
      ...
      <div className="mb-8">
        <h3 className="mb-2 text-lg font-semibold">Refund Process</h3>
        ...
        <p>
          We will review the request and verify the eligibility criteria. If eligible, refunds will be processed within 5-7 business days via the original
          payment method used.
        </p>
      </div>
      <div className="mb-8">
      ...
      <div>
        <h3 className="mb-2 text-lg font-semibold">Policy Changes</h3>
        <p>
          We reserve the right to modify or amend this refund policy at any time. Customers will be notified of any changes via email or through our website.
        </p>
      </div>
    </div>
  );
