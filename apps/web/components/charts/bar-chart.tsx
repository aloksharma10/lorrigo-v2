...
const BarChartContainer = dynamic(
  () =>
    import('recharts').then((mod) => ({
      default: React.memo(function BarChartComponent({ data, bars, xAxisDataKey, showGrid, showLegend, showTooltip }: any) {
...
export const BarChart = React.memo(function BarChart({
  ...
  return (
    <div style={{ width: '100%', height }}>
      <BarChartContainer data={data} bars={bars} xAxisDataKey={xAxisDataKey} showGrid={showGrid} showLegend={showLegend} showTooltip={showTooltip} />
    </div>
  );
});
