...
const DynamicPieChart = dynamic(
            ...
            <ResponsiveContainer width="100%" height="100%">
              <PieChart>
                ...
                >
                  ...
                  {showDataLabels && <Label value={`Total: ${data.reduce((sum: number, item: any) => sum + item.value, 0)}`} position="center" fill="#111" />}
                </Pie>
                <Tooltip
  ...
  {
    ssr: false,
    loading: () => <div className="flex h-full items-center justify-center">Loading chart...</div>,
  }
);
...
export function PieChart({
  ...
  if (!mounted) return <div className="flex h-[300px] items-center justify-center">Loading...</div>;
