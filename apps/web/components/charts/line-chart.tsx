...
const LineChartContainer = dynamic(
  () =>
    import('recharts').then((mod) => ({
      default: React.memo(function LineChartComponent({ data, lines, xAxisDataKey, showGrid, showLegend, showTooltip }: any) {
...
export const LineChart = React.memo(function LineChart({
  ...
  return (
    <div style={{ width: '100%', height }}>
      <LineChartContainer data={data} lines={lines} xAxisDataKey={xAxisDataKey} showGrid={showGrid} showLegend={showLegend} showTooltip={showTooltip} />
    </div>
  );
});
